...
For more information, plz check (https://github.com/spica-matrix/wiki/blob/master/tutorials/%5BEnglish%5D%20Nebulas%20101%20-%2003%20Smart%20Contracts%20JavaScript.md) and [rpc.sendTransaction](https://github.com/spica-matrix/wiki/blob/master/rpc.md#sendtransaction).
